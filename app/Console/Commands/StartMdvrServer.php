...
class StartMdvrServer extends Command
{
    ...
    private function respondRegistration($socket, $phoneRaw, $devSerial, $body)
    {
        ...
        // =====================================================
        // CONSTRUIR RESPUESTA 0x8100 (Estructura Segura ULV)
        // =====================================================
        // Usamos una contraseña simple de 6 dígitos
        $authCode = '123456';  // Contraseña simple que no causa desconexión

        $this->info('   ─────────────────────────────────────────────────');
        $this->info("   Auth Code a enviar: <fg=green>$authCode</> (longitud: ".strlen($authCode).')');

        // ESTRUCTURA SEGURA (11 bytes total):
        // ┌────────┬────────┬────────┬────────┬────────┬───────────────────────┐
        // │ Byte 0 │ Byte 1 │ Byte 2 │ Byte 3 │ Byte 4 │ Byte 5+               │
        // ├────────┼────────┼────────┼────────┼────────┼───────────────────────┤
        // │ Serial │ Serial │ Result │RELLENO │ Length │ Auth Code             │
        // │  High  │  Low   │  (00)  │  (00)  │  (06)  │ "123456"              │
        // └────────┴────────┴────────┴────────┴────────┴───────────────────────┘
        //
        // Byte 0-1: Reply Serial Number (copia del recibido)
        // Byte 2:   Result (0x00 = Éxito)
        // Byte 3:   RELLENO (0x00) - El hueco del manual
        // Byte 4:   Length (0x06) - Longitud del código
        // Byte 5+:  Auth Code ("123456")
        ...
        $responseBody = [
            ...
            0x00,                        // Byte 3: RELLENO
            strlen($authCode),           // Byte 4: Length (0x06)
        ];
